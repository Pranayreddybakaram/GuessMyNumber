...
public class GuessingGame1 {
    ...
    public static void main(String[] args) {
        ...
        while (userAnswer != secretNumber) {
            ...
            JOptionPane.showMessageDialog(null, "" + calculateGuess(userAnswer, secretNumber, count));
            count++;
        }
    }

    // TODO: Refactor / Rename determineGuess to calculateMessage
    public static String calculateGuess(int userAnswer, int computerNumber, int count) {
